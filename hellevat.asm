...
;    jmp     verifica_descendo_subindo ; se não estava parado, tem que verificar se está subindo ou descendo
    ...
    mov     byte[andar_desejado],4
    jmp     fim_atualiza
    ext_aux_muda_direcao:
    mov     byte[direcao_movimento],1
    ext_verifica_descendo_subindo:
    cmp     byte[direcao_movimento],1 ; verifica se a direção do elevador é de subida
    jne     ext_atende_menor_abaixo_da_atual ; se não está subindo, está descendo... procede lógica de descida
    ...
    jz      ext_atende_menor_abaixo_da_atual        ; se não há pedidos e deu jz aqui, então deu erro??
    cmp     byte[andar_atual],4
    ...
    ext_jcurto_muda_direcao:
    jmp     ext_aux_muda_direcao
    ...
    jz      ext_jcurto_muda_direcao        ; se não há pedidos e deu jz aqui, deu algum erro!
    cmp     byte[andar_atual],1
